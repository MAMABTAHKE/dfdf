...
l = Question('Как меня зовут?','Иван','Сашка', 'Пашка', 'Братик')
i = Question("Моя фамилия?", "Останков", 'Лушников', 'Тен', 'Да')
k = Question("Моё отчество?", 'Сергеевич', 'Иванович', 'Жукович', 'Лимитович')
b = Question('Город моего проживания?', 'Волжский', 'Жуков', 'Алма - Ата', 'Москва')
